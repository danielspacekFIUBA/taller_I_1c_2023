...
impl Ahorcado{
    pub fn new(palabra: String) -> Self {
        ...
        let mut ahorcado = Ahorcado { palabra, letras_intentadas, letras_adivinadas, palabra_oculta_actual, resuelto };
        ahorcado.completar_palabra();
        ahorcado
    }

    pub fn agregar_letra(&mut self, letra: String) -> bool{
        let letras_actuales_acertadas = self.letras_adivinadas.len();
        ...
        self.letras_adivinadas.len() != letras_actuales_acertadas
    }
